...
export const metadata: Metadata = {
  title: 'Sync Blackbaud Schedules to Google or Outlook | SchoolCal',
  description: 'Automatically sync Blackbaud schedules and events to users primary Google or Outlook calendars.',
  openGraph: {
    ...
    <div className="min-h-screen bg-background-white">
          ...
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="heading-display text-text-black mb-6">
                Sync Blackbaud schedules to Google or Outlook calendars
              </h1>
              <p className="max-w-2xl mx-auto body-large text-text-dark-blue mb-8">
                Automatically sync event data from Blackbaud to staff and students' primary Google or Outlook calendars.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="heading-2 text-text-black mb-4">
              Trusted by Blackbaud schools like...
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      No matter which Schedule Set your school uses, SchoolCal syncs teacher and student class schedules directly to their primary Google calendars. As changes occur in Blackbaud (like add/drops, Schedule Set adjustments, or Special Days) availability updates automatically in real time. This not only helps individuals manage their day but also solves the broader challenge of finding meeting times across constantly shifting school schedules.
                    </p>
                  </div>
                </div>
                ...
                {/* Resource Calendars */}
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  <input type="checkbox" name="accordion" id="resource-calendars" className="hidden" />
                  <label 
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Map Blackbaud Buildings, Rooms, and Athletic Venues to Google/Outlook Resource Calendars for instant free/busy visibility. Staff no longer need to guess or double-check spreadsheets to see if a room, gym, or lab is available. Availability shows up directly within your existing calendar interface, exactly where people are already scheduling, making double bookings a thing of the past.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Ensure players, coaches, and families are always in sync by pulling Blackbaud athletic games and practices straight into their primary calendars. These events automatically update as changes are made in Blackbaud, giving everyone accurate visibility. Plus, you can set event "start times" based on class dismissal rather than the official event time to better reflect when students and coaches are actually unavailable.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Ditch outdated iCal feeds. With SchoolCal, you can sync Blackbaud Events, organized by Event Categories, into overlay calendars with precision. Choose exactly which categories display and control how they appear to your community. Whether it's a faculty meeting, parent event, division calendar, athletic schedule, or a school-wide calendar, you decide what's public, private, or internal, and SchoolCal makes sure it shows up accurately.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Simplify rotating schedules by syncing Blackbaud Day Labels as free all-day events on primary calendars. Whether you're running a standard rotation, working with multiple Schedule Sets, or applying Special Day override labels, the correct Day Label appears right on everyone's calendar. This makes it easy for students, parents, and teachers to keep track of the day, while also giving clarity to staff outside the classroom.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Recognize every member of your community with automatic birthday calendars powered by Blackbaud. Birthdates (excluding years) can sync to one or more calendars, separated by division, employee vs. student, or other criteria you choose. Extend these calendars to faculty, parents, or even digital signage for a school-wide culture of recognition, without the manual upkeep.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-background-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="heading-2 text-text-black mb-8">
              Sync Blackbaud data, effortlessly
            </h2>
