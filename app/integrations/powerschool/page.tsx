...
export const metadata: Metadata = {
  title: 'Sync PowerSchool Schedules to Google or Outlook | SchoolCal',
  description: 'Automatically sync PowerSchool schedules and events to users primary Google or Outlook calendars.',
  openGraph: {
          ...
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="heading-display text-text-black mb-6">
                Sync PowerSchool schedules to Google or Outlook calendars
              </h1>
              <p className="max-w-2xl mx-auto body-large text-text-dark-blue mb-8">
                Automatically sync event data from PowerSchool to staff and students' primary Google or Outlook calendars.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="heading-2 text-text-black mb-4">
              Trusted by PowerSchool schools like...
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/powerschool-customer-cardinal-gibbons.png"
                alt="Cardinal Gibbons School logo"
                width={140}
                height={56}
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/powerschool-customer-cardinal-gibbonscustomer-american-school-of-milan.png"
                alt="American School of Milan logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/powerschool-customer-cardinal-gibbonscustomer-depaul.png"
                alt="DePaul College Prep logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/powerschool-customer-new-trier.png"
                alt="New Trier High School logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
            ...
            <div>
              ...
              <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg overflow-hidden">
                        <Image
                          src="/logos/powerschool-square.png"
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Map your PowerSchool Rooms to Google/Outlook Resource Calendars and instantly see free/busy status for all spaces. Whether it's a classroom, lab, gym, or shared facility, availability is visible right inside the calendar interface staff already use, eliminating double bookings and the hassle of searching for open rooms.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Keep everyone on the same page by syncing PowerSchool Cycle Days as free all-day events on primary calendars. Whether tied to a Bell Schedule or defined in the Master Calendar, the correct Cycle Day label appears automatically. This makes it easy for students, parents, and teachers to track rotating schedules, while also supporting staff who work on standard Monday–Friday routines.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-background-white rounded-lg shadow-md border border-border accordion-item">
                  ...
                  <div className="px-6 pb-6 hidden" data-content>
                    <p className="body-medium text-text-dark-blue">
                      Celebrate your community automatically by syncing PowerSchool birthdays (without years) to one or multiple calendars. Customize your birthday calendars to exclude certain users, separate divisions, or distinguish between student and staff birthdays. You can even extend them to digital signage for school-wide recognition, making celebrations personal, effortless, and consistent.
                    </p>
                  </div>
                </div>
              </div>
