        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/veracross-customer-barker.png"
                alt="Barker College logo"
                width={140}
                height={56}
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/veracross-customer-gulliverprep.png"
                alt="Gulliver Preparatory School logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/veracross-customer-horace-mann.png"
                alt="Horace Mann School logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
            ...
            <div className="w-40 h-20 bg-background-white rounded-lg flex items-center justify-center border border-border shadow-sm p-1">
              <Image
                src="/logos/veracross-customer-sidwell-friends.png"
                alt="Sidwell Friends School logo"
                width={140}
                height={56}
                className="max-w-full max-h-full object-contain"
              />
